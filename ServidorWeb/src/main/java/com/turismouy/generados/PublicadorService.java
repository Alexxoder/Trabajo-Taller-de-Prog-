 ...
 * 
 */
@WebServiceClient(name = "PublicadorService", targetNamespace = "http://presentacion.src/", wsdlLocation = "http://localhost:9095/publicador?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9095/publicador?wsdl");
