                ...
                <div class="row">
                    <div class="col-3">
								<div class="alert alert-danger" role="alert">
                                   <p> La actividad aún tiene salidas vigentes</p>
                                </div>
                    ...
                    <div class="col-6">
                        ...
                        <br>
                        <%
                        	if (usrLogueado != null  && !esSesion) {
                        		List<DtUsuario> seguidos = usrLogueado.getListaSeguidos();
                        		Boolean loSigue = false;
	                        		int i = 0;
	                        		while (i < seguidos.size() && !(seguidos.get(i).getNickname().equals(provedor.getNickname()))){
	                        			i++;
	                        		}
	                        		loSigue = i < seguidos.size();
	                        		if (loSigue){
                        %>
                        <a class="btn btn-primary" href="/ServidorWeb/seguir?nickNameUsuario=<%= usrLogueado.getNickname() %>&nickNameASeguir=<%= provedor.getNickname() %>">Dejar de Seguir</a>
                        <%
                        			} else {
                        %>
                        <a class="btn btn-primary" href="/ServidorWeb/seguir?nickNameUsuario=<%= usrLogueado.getNickname() %>&nickNameASeguir=<%= provedor.getNickname() %>">Seguir</a>
                        <%
                        			}
                        	}
                        %>
