        ...
        <div class="row">
            ...
            <div class="list-group">
                                    ...
                                    <div class="row">
                                        <div class="col-9">
                                            <div class="col-6 link-dark text-decoration-none" href="?nombreActividad=<%= dtsalida.getNombre() %>">
                                                <div class="row">
                                                    <div class="col-6">
                                                    <% if (dtsalida.getImagen() != null || dtsalida.getImagen().equals(" ")) { %>
                ...
                <div class="alert alert-danger" role="alert">
                    <p> No hay suficientes cupos disponibles. Si lo desea, intente nuevamente con una cantidad de turistas menor.</p>
                </div>    
