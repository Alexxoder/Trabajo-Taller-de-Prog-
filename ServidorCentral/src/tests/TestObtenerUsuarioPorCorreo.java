...
class TestObtenerUsuarioPorCorreo {
...
private static IUsuario controlUser;
	...
	void TestObtenerUsuarioCorreo(){
		...
		Usuario user = controlUser.obtenerUsuarioPorCorreo(correo);
		assertEquals(user.getCorreo(), correo);
	}
}
