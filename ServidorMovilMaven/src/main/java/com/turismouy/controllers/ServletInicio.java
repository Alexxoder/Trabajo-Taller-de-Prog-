    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse resp)
        ...
        switch(getEstado(req)){
            case NO_LOGIN:
                ...
                req.getRequestDispatcher("/WEB-INF/home/inicioSesion.jsp").forward(req, resp);
                break;
            case LOGIN_INCORRECTO:
                // hace que se ejecute el jsp sin cambiar la url
                req.getRequestDispatcher("/WEB-INF/home/inicioSesionErroneo.jsp").forward(req, resp);
                break;
            case LOGIN_PROVEEDOR:
            	req.getRequestDispatcher("/WEB-INF/home/inicioSesionErroneoProveedor.jsp").forward(req,resp);
            	break;
            case LOGIN_CORRECTO:
                // manda una redirección a otra URL (cambia la URL)
                resp.sendRedirect("/ServidorMovil/inicio.jsp");
                break;
        }
