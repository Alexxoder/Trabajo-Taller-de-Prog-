        ...
        <div class="row">
          <div class="col p-0">
            <div class="dropdown">
              ...
              %>
                <li><a class="dropdown-item" href="?actividad=<%= dtActividad.getNombre() %>"><%= dtActividad.getNombre() %></a></li>
              <%
              		}
              %>
              </ul>
        ...
        <div class="list-group-item">
          <div class="row border-bottom">
            <div class="col-sm-9 mt-3">
              <a class=" col-6 link-dark text-decoration-none" href="?nombreSalida=<%= dtSalida.getNombre() %>">
                <div class="row">
                  <div class="col-sm-6">
